...
batch_size = 32  # per_device_train_batch_size
...
args = TrainingArguments(
    output_dir = "./checkpoints/mistral_attention",
...
trainer.train(resume_from_checkpoint="./checkpoints/mistral_attention/checkpoint-7215")

#Save the model

# Push your PEFT model (adapters)
model.push_to_hub("Saef/mistral_attention_all_100_epoch")

# Push the tokenizer as well
tokenizer.push_to_hub("Saef/mistral_attention_100_epoch")
