...
args = TrainingArguments(
    ...
    output_dir = "./checkpoints/mistral_dp_new",
...
lora_save_callback = LoRASaveCallback(model, save_dir="./checkpoints/mistral_dp_new")
trainer.add_callback(lora_save_callback)

print(f"Privacy parameters {privacy_args}")

# trainer.train()
trainer.train(resume_from_checkpoint="./checkpoints/mistral_dp_new/checkpoint-3960")
...
model.push_to_hub("Saef/mistral_attention_dp_new")

# Push the tokenizer as well
tokenizer.push_to_hub("Saef/mistral_attention_dp_new")
